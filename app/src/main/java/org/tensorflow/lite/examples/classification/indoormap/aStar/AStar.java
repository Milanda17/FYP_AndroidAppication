...
public class AStar {
    ...
    public AStar(int rows, int cols, Node initialNode, Node finalNode, int hvCost, int diagonalCost) {
        ...
        this.openList = new PriorityQueue<Node>(5, new Comparator<Node>()
    ...
    public void setBlocks(List<String> blocksArray, String start, String rawStartId, String columnStartId) {
        String[] parts = new String[0];

        for (int i = 0; i < blocksArray.size(); i++) {

            parts = blocksArray.get(i).split("-");
            String rawId = parts[0];
            String columnId = parts[1];
            int row = Integer.parseInt(rawId);
            int col = Integer.parseInt(columnId);
            int startRow = Integer.parseInt(rawStartId);
            int startCol = Integer.parseInt(columnStartId);
